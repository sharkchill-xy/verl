#!/bin/bash
# ReTool GRPO training with optimized configuration for 7B model + 8192 sequence length
# 方案1：高性能生产配置 - 支持 8192 prompt + 8192 response
...
EXPERIMENT_NAME=retool-grpo-qwen2.5-7b-optimized
