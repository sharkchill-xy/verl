#!/bin/bash
# ReTool GRPO training with strict length limits to prevent sequence overflow
# Fixed: Add max_seq_len and generation length limits
...
EXPERIMENT_NAME=retool-grpo-qwen2.5-7b-fixed
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/data2/lixy/VerlCoder/data/retool_dapo_split/train_filtered.parquet \
