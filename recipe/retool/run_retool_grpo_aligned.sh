#!/bin/bash
# ReTool GRPO training fully aligned with GSM8K successful configuration
...
EXPERIMENT_NAME=retool-grpo-qwen2.5-7b-aligned
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/data2/lixy/VerlCoder/data/retool_dapo_split/train.parquet \
