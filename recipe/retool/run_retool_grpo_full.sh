#!/bin/bash
# ReTool GRPO training with full dataset and optimized configuration
# Using full train.parquet with adjusted batch size and rollout count
...
EXPERIMENT_NAME=retool-grpo-qwen2.5-7b-full
